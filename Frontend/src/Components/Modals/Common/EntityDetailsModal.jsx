          ...
          <div className="flex items-center">
            ...
            <div>
              <div className="flex items-center gap-4">
                ...
                <span className="text-gray-600 capitalize mt-1">
                  {entity.age}
                </span>
              </div>
              {isDoctor && (
              ...
              <span
                className={`mt-2 inline-flex px-3 py-1 text-xs font-medium rounded-full ${
                  ...
                  <div className="flex items-center">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-600">
                        {entity.education || "Not specified"}
                      </p>
                    </div>
                  </div>
                  <div className="flex items-center">
                ...
                <div className="space-y-2">
                  ...
                  {entity.height && entity.weight && (
                    <div>
                      ...
                      <p className="text-sm text-gray-600">
                        Height: {entity.height} cm, Weight: {entity.weight} kg
                      </p>
                    </div>
                  )}
                </div>
