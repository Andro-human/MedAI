...
function Herosection() {
  return (
    <div className=" flex flex-row justify-around h-[80vh] px-24">
      <div className="flex flex-col space-y-6 justify-center items-center">
        ...
        <div>
          <p>
            We celebrate the good days, support each other through the tough
            ones, and never lose hope.
          </p>
        </div>
        {/* buttons */}
        <div className="flex flex-row space-x-4">
          <button className="btn w-48 h-12 bg-blue-800 text-white hover:bg-blue-500">
            Appointment
          </button>
